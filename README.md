...
For the complete wallet and TxLINE setup, see [WALLET_SETUP.md](WALLET_SETUP.md), [TXLINE_INTEGRATION.md](TXLINE_INTEGRATION.md), and [JUDGE_SETUP.md](JUDGE_SETUP.md).
