...
Visual reference: [generated desktop/mobile concept](../assets/momento-ui-concept.png). It is directional; do not copy team crests or generated faces/assets into production without rights.

![Momento responsive UI concept](../assets/momento-ui-concept.png)
